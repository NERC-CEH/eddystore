...
library(devtools)
install_github("NERC-CEH/eddystore", auth_token = "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")
library(eddystore)
```
<!--- } -->
...
myJob <- createJob(stationID_proc, procID_proc, startDate_period, endDate_period, 
  binpath = "/gws/nopw/j04/eddystore/eddypro/eddypro-engine_7.0.9/bin/linux/eddypro_rp",
  nProcessors, job_name = "Test_Jan2023")
myJob
